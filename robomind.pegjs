...
Repeat "repeat" = i:ID & { return is(i, "repeat"); }
RepeatWhile "repeatWhile" = i:ID & { return is(i, "repeatWhile"); }

If "if" = i:ID & { return is(i, "if"); }
Else "else" = i:ID & { return is(i, "else"); }

Not "not" = i:ID & { return is(i, "not"); } { return i; }
And "and" = i:ID & { return is(i, "and"); } { return i; }
Or "or" = i:ID & { return is(i, "or"); } { return i; }

Break "break" = i:ID & { return is(i, "break"); } { return i; }
End "end" = i:ID & { return is(i, "end"); } { return i; }

Procedure "procedure" = i:ID & { return is(i, "procedure"); }
...
Identifier "identifier"
  ...
  // everywhere.
  = !Reserved id:ID { return id.toLowerCase(); }
